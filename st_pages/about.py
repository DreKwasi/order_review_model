...
def show_about():   
    ...
    stock_balance_template = pd.read_csv(
        "st_pages/templates/stock_balance_template.csv")
    ...
    if dispensation is not None:
        if dispensation.name != "cleaned_data.csv":
            ...
            with open(os.path.join("st_pages", dispensation.name), "wb") as f:
    ...
    if stock is not None:
        if stock.name != "cleaned_stock_balance.csv":
            ...
            with open(os.path.join("st_pages", stock.name), "wb") as f:
